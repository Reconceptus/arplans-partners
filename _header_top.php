...
<div class="hide">
    ...
    <svg xmlns="http://www.w3.org/2000/svg">
        <symbol id="icon-arrow-left-long" viewBox="0 0 15716 5949">
            <path d="m3195 5614c76 77 76 201 0 278-77 76-201 76-278 0l-2917-2917 2917-2917c77-77 201-77 278 0 76 76 76 200 0 277l-2443 2443h14767c109 0 197 88 197 197 0 108-88 196-197 196h-14767l2443 2443"
                  fill-rule="nonzero"/>
        </symbol>
        <symbol id="icon-basket" viewBox="0 0 5.53 5.16">
            <g>
                <path d="M0,2H.94l.88-2,.43.2L1.45,2H4.08L3.29.2,3.71,0l.88,2h.94v.37H5.27L4.62,5.16H.91L.26,2.32H0Zm4.79.37H.74L1.3,4.68H4.22Z"
                      fill="currentColor"/>
            </g>
        </symbol>
        <symbol id="icon-count-minus" viewBox="0 0 169 169">
            <g shape-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd"
               clip-rule="evenodd">
        ...
        <symbol id="icon-count-plus" viewBox="0 0 169 169">
            <g shape-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd"
               clip-rule="evenodd">
        ...
        <symbol id="icon-fb" viewBox="0 0 3000 3000">
            <path d="m897 1149v431h345v1046h430v-1046h431v-431h-431v-219c0-73 47-132 86-132h345v-424h-345c-284 0-516 252-516 563v212h-345"
                  fill="currentColor"/>
        </symbol>
        <symbol id="icon-feature" viewBox="0 0 4.79 4.34">
            <g fill="currentColor">
                <path d="M2.41 1.7A2.4 2.4 0 0 0 0 4.09a.25 .25 0 0 0 .23 .26H4.57a.25 .25 0 0 0 .23 -.26A2.4 2.4 0 0 0 2.41 1.7M.48 3.86A1.93 1.93 0 0 1 2.41 2.18a1.9 1.9 0 0 1 1.9 1.67"/>
                <path d="M2.41,1.45a2.74,2.74,0,0,1,2,.88L4.71,2a2.9,2.9,0,0,0-1.25-.85A.76.76,0,0,0,3.6.74.73.73,0,0,0,2.89,0a.68.68,0,0,0-.48.2A.8.8,0,0,0,1.93,0a.75.75,0,0,0-.74.74.76.76,0,0,0,.14.43A2.9,2.9,0,0,0,.09,2l.34.31A2.75,2.75,0,0,1,2.41,1.45Zm.48-1h0a.25.25,0,0,1,.23.26A.24.24,0,0,1,2.89,1,.25.25,0,0,1,2.64.74.25.25,0,0,1,2.89.48Zm-1,0h0a.25.25,0,0,1,.23.26A.24.24,0,0,1,1.93,1,.25.25,0,0,1,1.67.74.25.25,0,0,1,1.93.48Z"/>
            </g>
        </symbol>
        <symbol id="icon-file-change" viewBox="0 0 271 271">
            <path fill="currentColor"
                  d="m125 229h-100v-221h114l56 56v57c12 3 22 9 31 17 12 13 20 30 20 48 0 19-8 36-20 48-13 12-29 20-48 20-19 0-36-8-48-20-2-2-3-3-5-5m17-51h27v-28h17v28h28v17h-28v27h-17v-27h-27v-17m36-59v-43h-51v-51h-85v187h73c-3-8-5-17-5-26 0-18 8-35 20-48 12-12 29-19 48-19m-36 31c-9 9-15 22-15 36 0 14 6 27 15 36 9 9 22 15 36 15 14 0 27-6 36-15 9-9 15-22 15-36 0-14-6-27-15-36-9-9-22-15-36-15-14 0-27 6-36 15m24-91l-22-22v22h22"
                  fill-rule="nonzero"/>
        </symbol>
        <symbol id="icon-gg" viewBox="0 0 3000 3000">
            <path d="m1590 2128c0-251-258-451-580-451h-45c-13-26-20-58-20-96 0-33 7-97 20-97h13c264 0 483-213 483-483 0-65-32-142-65-181l168-89v-317l-348 191c-77-50-155-81-251-81-264 0-477 213-477 477 0 154 71 283 180 373-32 65-45 136-45 207 0 64 13 128 39 186-142 84-232 213-232 361 0 254 258 458 580 458 322 0 580-204 580-458m438-475v-383h-381v-160h381v-380h162v380h380v160h-380v383h-162m-825-652c0 128-103 225-225 225-123 0-226-97-226-225 0-123 103-226 226-226 122 0 225 103 225 226m65 1127c0 97-116 174-258 174-142 0-258-77-258-174 0-96 116-174 258-174 142 0 258 78 258 174"
                  fill="currentColor"/>
        </symbol>
        <symbol id="icon-heart-like" viewBox="0 0 6.26 5.04">
            <g>
                <path d="M2.89,5c0-.23-.37-.43-.82-.65C1.16,3.91,0,3.29,0,1.67A1.72,1.72,0,0,1,.54.51,1.63,1.63,0,0,1,1.7,0a1.5,1.5,0,0,1,1,.28,1.31,1.31,0,0,1,.45.43A2.13,2.13,0,0,1,3.57.28a1.64,1.64,0,0,1,1-.28A1.63,1.63,0,0,1,5.72.51a1.72,1.72,0,0,1,.54,1.16c0,1.62-1.16,2.24-2.07,2.72-.45.23-.82.43-.82.65ZM2.3,4a3.17,3.17,0,0,1,.82.54A3.38,3.38,0,0,1,4,4c.79-.43,1.81-1,1.81-2.3a1.25,1.25,0,0,0-.4-.82A1.12,1.12,0,0,0,4.56.48a1.06,1.06,0,0,0-.71.2,1.35,1.35,0,0,0-.51.6l-.23.34-.2-.34a1.35,1.35,0,0,0-.51-.6A1.06,1.06,0,0,0,1.7.48,1.12,1.12,0,0,0,.88.85a1.25,1.25,0,0,0-.4.82C.48,3,1.5,3.54,2.3,4Z"
                      fill="#657482"/>
            </g>
            <g fill="currentColor">
        ...
        <symbol id="icon-phone" viewBox="0 0 271 271">
            <path d="m85 186c15 16 32 28 48 38 23 15 44 24 57 29 3 1 6 1 8 0 3 0 5-2 7-4l31-30c1-1 1-2 1-3 0 0 0-1-1-2l-41-41c0 0-1-1-2-1-1 0-1 1-2 1l-28 29-6-2c0 0-29-12-52-35-22-22-34-52-34-52l-2-5 28-28c1-1 1-2 1-3 0 0 0-1-1-2l-41-41c0 0-1-1-2-1-1 0-1 1-2 1l-31 31c-2 2-3 5-4 7 0 3 0 6 1 8 5 14 14 35 28 58 10 15 23 32 39 48m39 53c-17-11-35-24-51-41-17-17-30-35-41-51-15-25-25-47-30-61-2-5-3-12-1-17 1-6 4-11 8-16l31-31c4-3 9-5 14-5 5 0 10 2 14 5l41 41c4 4 6 9 6 14 0 6-2 11-6 15l-20 20c4 8 14 26 28 41 15 15 33 25 42 29l20-21c4-4 9-5 14-5 5 0 10 1 14 5l41 41c4 4 6 9 6 14 0 6-2 11-6 15l-31 30c-4 5-9 8-15 9-6 1-12 1-18-1-14-5-36-15-60-30"
                  fill="currentColor" fill-rule="nonzero"/>
        </symbol>
        <symbol id="icon-remove" viewBox="0 0 4.34 4.57">
            <g fill="currentColor">
                <path d="M.48,4.09A.5.5,0,0,0,1,4.57H3.38a.5.5,0,0,0,.48-.48V1.19H.48ZM1,1.67H3.38V4.09H1Z"/>
                <path d="m2.89.48v-.48h-1.44v.48h-1.45v.48h4.34v-.48h-1.45"/>
                <path d="m1.45 3.6h.48v-1.44h-.48v1.44"/>
                <path d="m2.41 3.6h.48v-1.44h-.48v1.44"/>
            </g>
        </symbol>
        <symbol id="icon-search" viewBox="0 0 5400 5400">
            <path d="m2336 4011c462 0 882-188 1185-490 303-303 490-722 490-1185 0-463-188-882-490-1185-303-303-723-491-1185-491-463 0-883 188-1186 490-302 304-490 723-490 1186 0 462 187 881 489 1185 305 303 724 490 1187 490m2955 725c153 153 154 401 2 555-153 153-402 154-556 2l-1046-1047c-383 272-851 432-1355 432-646 0-1232-262-1655-686-425-425-688-1011-688-1656 0-647 263-1233 686-1657 425-423 1011-686 1657-686 646 0 1233 263 1656 686 424 424 686 1010 686 1657 0 504-160 972-432 1355l1045 1045"
                  fill="currentColor" fill-rule="nonzero"/>
        </symbol>
        <symbol id="icon-site-changes" viewBox="0 0 10700 10700">
            <g fill="none" fill-rule="nonzero" stroke="#21202e" stroke-width="667">
                <path d="m10359 7672h-10001l-10-5001h10001z"/>
                <path d="m4682 5672v-2845"/>
                <path d="m7349 5672v-2845"/>
                <path d="m6015 4672v-1834"/>
                <path d="m2015 5672v-2845"/>
                <path d="m3349 4672v-1889"/>
                <path d="m8683 4674v-1710"/>
            </g>
        </symbol>
        <symbol id="icon-site-delivery" viewBox="0 0 7.68 5.41">
            <g>
                <path d="M7.17,4.31h0V2.66L6.77,1.42H5.27V4.11a1.61,1.61,0,0,1,.23-.37,1.06,1.06,0,0,1,.71-.28,1,1,0,0,1,.68.28A.84.84,0,0,1,7.17,4.31ZM.51,1.9H2.15v.48H.51ZM.23.94H2.64v.48H.23Zm3,3.37H4.79V.45H0V0H5.27V.94H7.11l.57,1.64V4.79H7.11a.72.72,0,0,1-.23.34,1,1,0,0,1-.68.28,1.06,1.06,0,0,1-.71-.28,1,1,0,0,1-.23-.34H3.15a.56.56,0,0,1-.23.34,1,1,0,0,1-.68.28,1.06,1.06,0,0,1-.71-.28,1,1,0,0,1-.23-.34H.48V2.86H1V4.31h.31a1,1,0,0,1,.26-.57,1.06,1.06,0,0,1,.71-.28,1,1,0,0,1,.68.28A.84.84,0,0,1,3.2,4.31Zm-.62.48a.4.4,0,0,0,.17-.34.46.46,0,0,0-.17-.37.47.47,0,0,0-.34-.14.6.6,0,0,0-.37.14.54.54,0,0,0-.14.37.47.47,0,0,0,.14.34.6.6,0,0,0,.37.14A.47.47,0,0,0,2.58,4.79Zm4,0a.47.47,0,0,0,.14-.34.54.54,0,0,0-.14-.37.47.47,0,0,0-.34-.14.49.49,0,0,0-.51.51.47.47,0,0,0,.14.34.54.54,0,0,0,.37.14A.47.47,0,0,0,6.55,4.79Z"
                      fill="currentColor"/>
            </g>
        </symbol>
        <symbol id="icon-site-documents" viewBox="0 0 6.04 6.49">
            <g>
                <path d="M1.36,1.9,1,2.35A.4.4,0,0,0,1,2.52.4.4,0,0,0,1,2.69l.37.48a4.45,4.45,0,0,0,.11.65h0l.06.06,0,0L1.59,4A.22.22,0,0,0,1.73,4l.6.11.51.34c0,.06.11.06.17.06a.21.21,0,0,0,.17-.06l.48-.34L4.28,4A.48.48,0,0,0,4.42,4s0-.06.06-.09h0s0,0,0-.06a4.54,4.54,0,0,0,.09-.65L5,2.69A.4.4,0,0,0,5,2.52.4.4,0,0,0,5,2.35l-.37-.51-.09-.6a.24.24,0,0,0-.09-.17A.62.62,0,0,0,4.28,1L3.66.91,3.17.54A.4.4,0,0,0,3,.48a.3.3,0,0,0-.17.06L2.32.91,1.73,1l-.17.09-.09.17-.09.6ZM2.66,5l-1,1.53L1.19,5.38H0L1,3.85.94,3.37.65,3a.75.75,0,0,1-.17-.45.69.69,0,0,1,.17-.45l.28-.4L1,1.16a.74.74,0,0,1,.2-.43.74.74,0,0,1,.43-.2L2.15.45l.4-.28A.69.69,0,0,1,3,0a.75.75,0,0,1,.45.17l.4.28.48.09a.74.74,0,0,1,.43.2A.78.78,0,0,1,5,1.16l.09.51.28.4a.86.86,0,0,1,.14.45A.94.94,0,0,1,5.36,3l-.28.4L5,3.8,6,5.38H4.85L4.39,6.49l-1-1.56A.75.75,0,0,1,3,5,1.42,1.42,0,0,1,2.66,5ZM1.28,4.34l-.4.57H1.5l.23.57.54-.79-.11-.09-.51-.09A.74.74,0,0,1,1.28,4.34Zm2.47.31.57.82.23-.57h.62l-.4-.6,0,0a1,1,0,0,1-.4.17l-.48.09Z"
                      fill="currentColor"/>
            </g>
        </symbol>
        <symbol id="icon-site-forrussia" viewBox="0 0 7.68 6.49">
            <g>
                <path d="M6.55,6.49H1.13a1,1,0,0,1-.79-.34A1.14,1.14,0,0,1,0,5.36V0H5.75V2.18H7.68V5.36a1.14,1.14,0,0,1-.34.79A1,1,0,0,1,6.55,6.49ZM3.12,5H4.79v.48H3.12ZM1,5H2.64v.48H1Zm2.15-1H4.79v.48H3.12ZM1,4.08H2.64v.48H1Zm2.15-1H4.79V3.6H3.12ZM1,3.12H2.64V3.6H1Zm3.6-.45H1.19V1.22h3.6V2.66ZM1.67,2.18H4.31V1.7H1.67ZM7.2,5.36V2.66H5.75V5.36h0A.54.54,0,0,0,6,5.78.77.77,0,0,0,6.52,6h0a.68.68,0,0,0,.65-.65ZM5.27,2.41h0V.48H.48V5.36A.68.68,0,0,0,1.13,6H5.53a.9.9,0,0,1-.26-.65h0Z"
                      fill="currentColor"/>
            </g>
        </symbol>
        <symbol id="icon-site-money" viewBox="0 0 6.23 6.15">
            <g>
                <path d="M5.75,1.53a.1.1,0,0,1-.09,0,2.55,2.55,0,0,1-1.11.23,2.79,2.79,0,0,1-1.13-.23.1.1,0,0,1-.09,0v.4h0a.51.51,0,0,0,.28.26,2.21,2.21,0,0,0,.94.17,2.07,2.07,0,0,0,.91-.17c.17-.09.28-.17.28-.26h0ZM.48,4.87v.4c0,.09.11.17.26.23a2.25,2.25,0,0,0,.91.17,2.07,2.07,0,0,0,.91-.17c.17-.06.28-.14.28-.23v-.4l-.09,0a2.55,2.55,0,0,1-1.11.23A2.42,2.42,0,0,1,.57,4.9Zm2.83-.23v.62c0,.28-.23.51-.57.68a3.08,3.08,0,0,1-1.11.2A2.92,2.92,0,0,1,.57,6C.2,5.78,0,5.55,0,5.27V3.2c0-.28.2-.51.57-.68a2.92,2.92,0,0,1,1.08-.2,3.08,3.08,0,0,1,1.11.2c.06,0,.09.06.11.06V.88c0-.28.23-.51.57-.68A3.38,3.38,0,0,1,4.56,0,3.08,3.08,0,0,1,5.67.2c.34.17.57.4.57.68V4a.8.8,0,0,1-.57.68,2.55,2.55,0,0,1-1.11.23A2.79,2.79,0,0,1,3.43,4.7.21.21,0,0,1,3.32,4.65ZM.48,3.85v.4c0,.06.11.14.26.23a2.25,2.25,0,0,0,.91.17,2.07,2.07,0,0,0,.91-.17c.17-.09.28-.17.28-.23v-.4l-.09,0a3.08,3.08,0,0,1-1.11.2,2.92,2.92,0,0,1-1.08-.2Zm2.07-.43c.17-.06.28-.14.28-.23h0c0-.09-.11-.17-.28-.23a2.07,2.07,0,0,0-.91-.17A2.25,2.25,0,0,0,.74,3C.6,3,.48,3.12.48,3.2h0c0,.09.11.17.26.23a2.25,2.25,0,0,0,.91.17A2.07,2.07,0,0,0,2.55,3.43Zm.79.2V4c0,.09.11.17.28.26a2.21,2.21,0,0,0,.94.17,2.07,2.07,0,0,0,.91-.17c.17-.09.28-.17.28-.26v-.4l-.09,0a2.55,2.55,0,0,1-1.11.23,2.79,2.79,0,0,1-1.13-.23Zm0-1V3h0a.51.51,0,0,0,.28.26,2.21,2.21,0,0,0,.94.17,2.07,2.07,0,0,0,.91-.17c.17-.09.28-.17.28-.26h0v-.4l-.09,0a2.55,2.55,0,0,1-1.11.23,2.79,2.79,0,0,1-1.13-.23ZM5.47,1.13C5.64,1,5.75,1,5.75.91v0c0-.06-.11-.14-.28-.23A2.07,2.07,0,0,0,4.56.48a2.21,2.21,0,0,0-.94.17c-.17.09-.28.17-.28.23v0a.63.63,0,0,0,.28.23,2.21,2.21,0,0,0,.94.17A2.07,2.07,0,0,0,5.47,1.13Z"
                      fill="currentColor"/>
            </g>
        </symbol>
        <symbol id="icon-vk-reviews" viewBox="0 0 593 508">
            <path d="m198 42h197c109 0 198 90 198 199 0 109-89 198-198 198h-159v64l-127-85c-65-32-109-100-109-177 0-109 89-199 198-199"
                  fill="#63b6f7"/>
            <path d="m236 281c23 23 48 22 48 22h12c0 0 4 0 5-2 2-2 2-6 2-6 0 0 0-15 7-17 7-3 16 15 26 21 7 5 13 4 13 4h26c0 0 13-1 7-12-1 0-4-7-19-22-17-15-14-13 5-39 12-16 17-25 15-29-1-4-10-3-10-3h-29c0 0-2-1-4 0-1 1-2 4-2 4 0 0-5 12-11 22-13 22-18 24-20 22-5-3-4-13-4-19 0-22 3-31-7-33-3-1-5-1-13-1-11-1-19 0-24 2-4 2-6 5-5 6 2 0 7 1 9 4 3 4 3 13 3 13 0 0 2 25-4 28-4 3-10-2-21-22-6-10-11-21-11-21 0 0 0-3-2-4-2-1-4-2-4-2l-28 1c0 0-4 0-6 2-1 1 0 4 0 4 0 0 22 51 46 77"
                  fill="#fbfcfc"/>
            <path d="m481 5h23c39 0 70 32 70 71 0 19-7 36-20 49l-1 1-48 48v-28h-1-23c-39 0-71-32-71-70 0-39 32-71 71-71"
                  fill="#2a7ec5"/>
        </symbol>
        <symbol id="icon-vk" viewBox="0 0 3000 3000">
            <path d="m928 1875c257 268 548 251 548 251h132c0 0 40-5 61-27 19-20 18-58 18-58 0 0-3-177 80-203 81-26 185 171 295 247 84 57 147 45 147 45l296-4c0 0 154-10 81-132-6-10-43-89-220-254-185-171-160-144 63-441 136-181 190-291 173-339-16-45-116-33-116-33l-332 2c0 0-25-3-43 8-18 10-30 35-30 35 0 0-52 140-122 260-148 251-208 264-232 249-56-37-42-147-42-225 0-243 37-345-72-371-36-9-63-15-155-15-119-2-219 0-276 28-38 18-67 60-49 62 22 3 71 13 98 49 34 47 33 151 33 151 0 0 19 286-46 322-45 24-106-25-238-253-68-117-119-246-119-246 0 0-10-25-27-37-22-16-51-21-51-21l-316 2c0 0-48 1-65 22-16 18-1 56-1 56 0 0 247 579 527 870"
                  fill="currentColor"/>
        </symbol>
    </svg>
